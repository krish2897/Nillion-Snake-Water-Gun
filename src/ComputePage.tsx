...
export default function Main() {
  const programName = 'snake_water_Gun';
  ...
  return (
    <div>
      <h1>snake water Gun on Nillion</h1>
      <p>Connect to Nillion with a user key, then follow the steps to play snake, water, Gun using nillion's blind computation</p>
